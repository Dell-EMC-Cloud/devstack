...
openstack port create provisioning --fixed-ip subnet=fsf-provisioning-subnet,ip-address=172.19.16.1 --network fsf-provisioning-net --dns-name psstack-provisioning-service
